    ...
    <div className="bg-background text-on-background font-body-md min-h-screen flex flex-col relative overflow-x-hidden">
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-margin-mobile py-stack-lg z-10 w-full max-w-md mx-auto">
        ...
        <div className="text-center mb-stack-lg animate-bounce">
          <h1 className="text-display-hero font-display-hero text-primary mb-stack-sm drop-shadow-md">ĐI THÔI!</h1>
          <p className="text-headline-md font-headline-md text-secondary">ĐA SỐ CHẤP NHẬN!</p>
        </div>
        ...
        <div className="w-full bg-surface-white rounded-xl shadow-[0_8px_24px_rgba(0,0,0,0.1)] border border-subtle-gray overflow-hidden mb-stack-lg relative transform transition-transform hover:scale-[1.02]">
          <div className="relative w-full h-48">
            <img className="w-full h-full object-cover" alt="Bún Bò Bà Luân" src="https://lh3.googleusercontent.com/aida-public/AB6AXuALk4dwkNUyR5ChcBEi3M73YQuX5xZMTFGpJc2bo49ylnPPsMi0siDmms2h3I8u_slf6tQrGyop4aO9CFvCLhdm1Y55bHN3n1WbyCz9m70qkGdqlDc6cFZMtVvpJc60F7-FsurmSgwfKUhtGwpVvcNt_etwZcRYegxebSBPJcgfFu9_nPJ6ER1LNbbuzIa_AJosS_QKVDtqEFSleXw-3_i16U-PMp_ffSVg49FVBDvRfWseioTLsf3lsQ" />
            {/* Overlay Gradient */}
            ...
            <div className="absolute bottom-4 left-4 flex gap-2">
              <div className="bg-surface-white/90 backdrop-blur-sm rounded-full px-3 py-1 flex items-center gap-1 shadow-sm">
                ...
                <span className="text-caption font-caption text-on-surface">4.5</span>
              </div>
              <div className="bg-surface-white/90 backdrop-blur-sm rounded-full px-3 py-1 flex items-center gap-1 shadow-sm">
                <span className="material-symbols-outlined text-tertiary text-[16px]">location_on</span>
                <span className="text-caption font-caption text-on-surface">1.2km</span>
              </div>
            </div>
          </div>
          <div className="p-4">
            <h2 className="text-headline-lg-mobile font-headline-lg-mobile text-on-surface mb-1">Bún Bò Bà Luân</h2>
            <div className="flex flex-wrap gap-2 mb-2">
              <span className="bg-surface-container-low border border-subtle-gray text-on-surface-variant px-2 py-0.5 rounded-md text-caption font-caption">Vietnamese</span>
              <span className="bg-surface-container-low border border-subtle-gray text-on-surface-variant px-2 py-0.5 rounded-md text-caption font-caption">Noodles</span>
            </div>
